...
import static com.sklep.gui.controllers.SklepController.dodajDoKoszyka;
import static com.sklep.gui.controllers.SklepController.produktyArrayList;

public class ListCell extends JFXListCell<Produkty_i_Zdjęcia> {
    ...
    @FXML
    private JFXButton dialogDodajDoKoszyka;
    @FXML
    ...
    protected void updateItem(Produkty_i_Zdjęcia item, boolean empty) {
        ...
        if (item != null) {
            ...
            dialogDodajDoKoszyka.setOnAction(event -> dodajDoKoszyka(item));
